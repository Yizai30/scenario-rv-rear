...
(assert (= (h_E 1) 0))
(assert (ite (t_E 1) (= (h_E 2) (+ (h_E 1) 1)) (= (h_E 2) (h_E 1))))
(assert (ite (t_E 2) (= (h_E 3) (+ (h_E 2) 1)) (= (h_E 3) (h_E 2))))
(assert (ite (t_E 3) (= (h_E 4) (+ (h_E 3) 1)) (= (h_E 4) (h_E 3))))
(assert (ite (t_E 4) (= (h_E 5) (+ (h_E 4) 1)) (= (h_E 5) (h_E 4))))
(assert (ite (t_E 5) (= (h_E 6) (+ (h_E 5) 1)) (= (h_E 6) (h_E 5))))
(assert (ite (t_E 6) (= (h_E 7) (+ (h_E 6) 1)) (= (h_E 7) (h_E 6))))
(assert (ite (t_E 7) (= (h_E 8) (+ (h_E 7) 1)) (= (h_E 8) (h_E 7))))
(assert (ite (t_E 8) (= (h_E 9) (+ (h_E 8) 1)) (= (h_E 9) (h_E 8))))
(assert (ite (t_E 9) (= (h_E 10) (+ (h_E 9) 1)) (= (h_E 10) (h_E 9))))
(assert (ite (t_E 10) (= (h_E 11) (+ (h_E 10) 1)) (= (h_E 11) (h_E 10))))
...
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (or (t_E x) (t_state.begin x) (t_state.end x) (t_tmp_1 x) (t_event1 x) (t_tmp_2 x)))))
(assert (and ( > (h_E 11) 0) (> (h_state.begin 11) 0) (> (h_state.end 11) 0) (> (h_tmp_1 11) 0) (> (h_event1 11) 0) (> (h_tmp_2 11) 0)))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_E x) (h_state.begin x)) (not (t_state.begin x)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_state.begin x) (h_state.end x)) (not (t_state.end x)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x (+ n 1))) (ite (>= (h_E x) 1) (= (h_tmp_1 x) (- (h_E x) 1)) (= (h_tmp_1 x) 0)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_state.end x) (h_tmp_1 x)) (not (t_tmp_1 x)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (=> (t_event1 x) (t_E x)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_state.begin x) (h_E x)) (not (t_E x)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_E x) (h_state.end x)) (not (t_state.end x)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x (+ n 1))) (ite (>= (h_state.begin x) 1) (= (h_tmp_2 x) (- (h_state.begin x) 1)) (= (h_tmp_2 x) 0)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_state.end x) (h_tmp_2 x)) (not (t_tmp_2 x)))))
(check-sat)
(get-value ((t_E 1)))
(get-value ((t_E 2)))
(get-value ((t_E 3)))
