...
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (or (t_state.begin x) (t_event1 x) (t_event2 x) (t_state.end x) (t_tmp_1 x) (t_tmp_2 x) (t_tmp_3 x)))))
(assert (and ( > (h_state.begin 11) 0) (> (h_event1 11) 0) (> (h_event2 11) 0) (> (h_state.end 11) 0) (> (h_tmp_1 11) 0) (> (h_tmp_2 11) 0) (> (h_tmp_3 11) 0)))
...
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (t_tmp_2 x) (and (t_event2 x) (exists ((m Int)) (and (>= m 1) (<= m x) (t_event2 m) (= (- (h_event2 x) (h_event2 m)) 1) (>= (- (h_state.end x) (h_state.end m)) 1))))))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (t_tmp_3 x) (and (t_event1 x) (exists ((m Int)) (and (>= m 1) (<= m x) (t_event1 m) (= (- (h_event1 x) (h_event1 m)) 1) (>= (- (h_state.end x) (h_state.end m)) 1))))))))
