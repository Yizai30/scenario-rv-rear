...
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_E x) (h_tmp_1 x)) (not (t_tmp_1 x)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_state.end x) (h_tmp_1 x)) (not (t_tmp_1 x)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x (+ n 1))) (>= (h_E x) (h_event1 x)))))
...
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_state.begin x) (h_tmp_2 x)) (not (t_tmp_2 x)))))
