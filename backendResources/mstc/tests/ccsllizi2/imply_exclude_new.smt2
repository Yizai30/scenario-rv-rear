...
(declare-fun t_s (Int) Bool)
(declare-fun h_s (Int) Int)
(assert (= (h_s 1) 0))
(assert (ite (t_s 1) (= (h_s 2) (+ (h_s 1) 1)) (= (h_s 2) (h_s 1))))
(assert (ite (t_s 2) (= (h_s 3) (+ (h_s 2) 1)) (= (h_s 3) (h_s 2))))
(assert (ite (t_s 3) (= (h_s 4) (+ (h_s 3) 1)) (= (h_s 4) (h_s 3))))
(assert (ite (t_s 4) (= (h_s 5) (+ (h_s 4) 1)) (= (h_s 5) (h_s 4))))
(assert (ite (t_s 5) (= (h_s 6) (+ (h_s 5) 1)) (= (h_s 6) (h_s 5))))
(assert (ite (t_s 6) (= (h_s 7) (+ (h_s 6) 1)) (= (h_s 7) (h_s 6))))
(assert (ite (t_s 7) (= (h_s 8) (+ (h_s 7) 1)) (= (h_s 8) (h_s 7))))
(assert (ite (t_s 8) (= (h_s 9) (+ (h_s 8) 1)) (= (h_s 9) (h_s 8))))
(assert (ite (t_s 9) (= (h_s 10) (+ (h_s 9) 1)) (= (h_s 10) (h_s 9))))
(assert (ite (t_s 10) (= (h_s 11) (+ (h_s 10) 1)) (= (h_s 11) (h_s 10))))
(declare-fun t_f (Int) Bool)
(declare-fun h_f (Int) Int)
(assert (= (h_f 1) 0))
(assert (ite (t_f 1) (= (h_f 2) (+ (h_f 1) 1)) (= (h_f 2) (h_f 1))))
(assert (ite (t_f 2) (= (h_f 3) (+ (h_f 2) 1)) (= (h_f 3) (h_f 2))))
(assert (ite (t_f 3) (= (h_f 4) (+ (h_f 3) 1)) (= (h_f 4) (h_f 3))))
(assert (ite (t_f 4) (= (h_f 5) (+ (h_f 4) 1)) (= (h_f 5) (h_f 4))))
(assert (ite (t_f 5) (= (h_f 6) (+ (h_f 5) 1)) (= (h_f 6) (h_f 5))))
(assert (ite (t_f 6) (= (h_f 7) (+ (h_f 6) 1)) (= (h_f 7) (h_f 6))))
(assert (ite (t_f 7) (= (h_f 8) (+ (h_f 7) 1)) (= (h_f 8) (h_f 7))))
(assert (ite (t_f 8) (= (h_f 9) (+ (h_f 8) 1)) (= (h_f 9) (h_f 8))))
(assert (ite (t_f 9) (= (h_f 10) (+ (h_f 9) 1)) (= (h_f 10) (h_f 9))))
(assert (ite (t_f 10) (= (h_f 11) (+ (h_f 10) 1)) (= (h_f 11) (h_f 10))))
...
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (or (t_state2.s x) (t_state1.s x) (t_state1.f x) (t_state2.f x) (t_tmp_1 x) (t_tmp_2 x) (t_s x) (t_f x) (t_tmp_3 x)))))
(assert (and ( > (h_state2.s 11) 0) (> (h_state1.s 11) 0) (> (h_state1.f 11) 0) (> (h_state2.f 11) 0) (> (h_tmp_1 11) 0) (> (h_tmp_2 11) 0) (> (h_s 11) 0) (> (h_f 11) 0) (> (h_tmp_3 11) 0)))
...
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (t_s x) (or (t_state1.s x) (t_state2.s x))))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (t_f x) (or (t_state1.f x) (t_state2.f x))))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_s x) (h_f x)) (not (t_f x)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x (+ n 1))) (ite (>= (h_s x) 1) (= (h_tmp_3 x) (- (h_s x) 1)) (= (h_tmp_3 x) 0)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (= (h_f x) (h_tmp_3 x)) (not (t_tmp_3 x)))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (or (not (t_state1.s x)) (not (t_state2.s x))))))
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (or (not (t_state1.f x)) (not (t_state2.f x))))))
(check-sat)
