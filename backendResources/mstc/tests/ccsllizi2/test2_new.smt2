...
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (or (t_state.begin x) (t_event1 x) (t_event2 x) (t_state.end x) (t_tmp_1 x) (t_tmp_2 x)))))
(assert (and ( > (h_state.begin 11) 0) (> (h_event1 11) 0) (> (h_event2 11) 0) (> (h_state.end 11) 0) (> (h_tmp_1 11) 0) (> (h_tmp_2 11) 0)))
...
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x (+ n 1))) (ite (>= (h_event2 x) 1) (= (h_tmp_2 x) (- (h_event2 x) 1)) (= (h_tmp_2 x) 0)))))
