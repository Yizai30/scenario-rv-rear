...
(assert (forall ((x Int)) (=> (and (>= x 1) (<= x n)) (or (t_tmp_1 x) (t_state1.s x) (t_state1.f x) (t_tmp_4 x) (t_state2.s x)))))
(assert (and ( > (h_tmp_1 11) 0) (> (h_state1.s 11) 0) (> (h_state1.f 11) 0) (> (h_tmp_4 11) 0) (> (h_state2.s 11) 0)))
